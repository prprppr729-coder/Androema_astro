...
body = {
    ...
    rightarm = {
        ...
        hologram.createPart(
            ...
            Holo(SubHolo(Vector(-3,-250,24),Angle(90,180,-90),"models/props_phx/gears/bevel9.mdl",Vector(5,5,9),true,Color(255,40,40,255),"models/props_combine/metal_combinebridge001")),
            Holo(SubHolo(Vector(-3,-260,24),Angle(90,180,-90),"models/props_phx/gears/bevel9.mdl",Vector(4,4,8),true,Color(255,40,40,255),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(-3,-260,24),Angle(90,180,-90),"models/props_phx/gears/bevel9.mdl",Vector(4.03,4.03,8.03),true,Color(255,255,255,255),"models/wireframe"))
        ),
        hologram.createPart(
            Holo(Rig(Vector(-3,-170,26),Angle(0,-90,0))),
            Holo(SubHolo(Vector(-3,-370,24),Angle(90,180,-90),"models/holograms/pyramid.mdl",Vector(4.01,4.01,10.05),true,Color(255,40,40,255),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(-3,-370,24),Angle(90,180,-90),"models/holograms/pyramid.mdl",Vector(4.01,4.01,10.06),true,Color(255,255,255,255),"models/wireframe"))
        )
    },
    leftarm = {
        hologram.createPart(
        ...
        laser = {
            hologram.createPart(
                Holo(Rig(Vector(-3,170,26),Angle(0,90,0))),
                Holo(SubHolo(Vector(-3,174,24),Angle(90,90,0),"models/hunter/triangles/trapezium3x3x1.mdl",Vector(0.3,0.3,0.3),false,Color(255,40,40,255),"models/props_combine/metal_combinebridge001"))
            ),
            hologram.createPart(
                Holo(Rig(Vector(-3,208,24),Angle(0,90,0))),
                Holo(SubHolo(Vector(-3,200,24),Angle(90,90,0),"models/hunter/tubes/tube1x1x8.mdl",Vector(0.28,0.28,0.30),true,Color(255,40,40,255),"models/debug/debugwhite")),
                Holo(SubHolo(Vector(-3,200,24),Angle(90,90,0),"models/hunter/tubes/tube1x1x8.mdl",Vector(0.29,0.29,0.31),true,Color(255,255,255,255),"models/wireframe")),
                Holo(SubHolo(Vector(-3,200,24),Angle(90,90,0),"models/props_trainstation/trainstation_ornament002.mdl",Vector(1,1,1.20),true,Color(255,40,40,255),"models/props_combine/metal_combinebridge001")),
                Holo(SubHolo(Vector(-3,220,24),Angle(90,90,0),"models/props_trainstation/trainstation_ornament002.mdl",Vector(1,1,1.20),true,Color(255,40,40,255),"models/props_combine/metal_combinebridge001")),
                Holo(SubHolo(Vector(-3,200,24),Angle(90,180,0),"models/props_wasteland/wheel01a.mdl",Vector(0.28,0.28,0.30),true,Color(255,40,40,255),"models/props_combine/metal_combinebridge001")),
                Holo(SubHolo(Vector(-3,210,24),Angle(90,180,0),"models/props_wasteland/wheel01a.mdl",Vector(0.28,0.28,0.30),true,Color(255,40,40,255),"models/props_combine/metal_combinebridge001")),
                Holo(SubHolo(Vector(-3,210,24),Angle(90,180,0),"models/props_wasteland/wheel01a.mdl",Vector(0.28,0.28,0.30),true,Color(255,40,40,255),"models/props_combine/metal_combinebridge001")),
                Holo(SubHolo(Vector(-3,220,24),Angle(90,180,0),"models/props_wasteland/wheel01a.mdl",Vector(0.28,0.28,0.30),true,Color(255,40,40,255),"models/props_combine/metal_combinebridge001")),
                Holo(SubHolo(Vector(-3,238,24),Angle(90,180,0),"models/props_wasteland/wheel01a.mdl",Vector(0.39,0.28,0.39),true,Color(255,40,40,255),"models/props_combine/metal_combinebridge001")),
                Holo(SubHolo(Vector(-3,238,24),Angle(0,0,90),"models/Items/combine_rifle_ammo01.mdl",Vector(3,3,3),true,Color(255,40,40,255),"")),
                Holo(SubHolo(Vector(-3,275,24),Angle(0,0,90),"models/Items/combine_rifle_ammo01.mdl",Vector(3,3,3),true,Color(255,40,40,255),"")),
                Holo(SubHolo(Vector(-3,310,24),Angle(0,0,-90),"models/Items/combine_rifle_ammo01.mdl",Vector(3,3,3),true,Color(255,40,40,255),"")),
                Holo(SubHolo(Vector(-3,190,24),Angle(0,90,10),"models/props_combine/headcrabcannister01a_skybox.mdl",Vector(13,13,13),true,Color(255,40,40,255),"")),
                Holo(SubHolo(Vector(-3,278,24),Angle(90,180,0),"models/props_wasteland/wheel01a.mdl",Vector(0.39,3.90,0.39),true,Color(255,40,40,255),"models/props_combine/metal_combinebridge001")),
                Holo(SubHolo(Vector(-3,288,24),Angle(90,180,90),"models/Items/combine_rifle_ammo01.mdl",Vector(3,3,3),true,Color(255,40,40,255),"models/props_combine/metal_combinebridge001")),
                Holo(SubHolo(Vector(-3,270,24),Angle(90,180,90),"models/Items/combine_rifle_ammo01.mdl",Vector(5,5,5),true,Color(255,40,40,255),"")),
                Holo(SubHolo(Vector(-3,200,24),Angle(90,180,90),"models/Items/combine_rifle_ammo01.mdl",Vector(5,5,9),true,Color(255,40,40,255),""))
                ),
            hologram.createPart(
