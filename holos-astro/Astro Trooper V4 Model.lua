--@name Astro Trooper V4 Model
--@author Ratyuha and hanid
--@server
...
local function blaster(offset)
    local blaster = hologram.createPart(
        ...
        Holo(SubHolo(Vector(-35,0,2),Angle(90,0,0),"models/Items/combine_rifle_ammo01.mdl",Vector(1.8,1.8,1.8),false,Color(255,40,40))),
        Holo(SubHolo(Vector(-35,0,2),Angle(90,0,0),"models/props_combine/combine_fence01a.mdl",Vector(0.4,0.4,0.4),false,Color(255,40,40))),
        Holo(SubHolo(Vector(-35,0,2),Angle(90,0,0),"models/Items/car_battery01.mdl",Vector(0.4,0.4,0.4),false,Color(255,40,40)))         
    )
...
body = {
    base = {
        hologram.createPart(
            ...
            Holo(SubHolo(Vector(23,0,5),Angle(10,0,0),"models/props_combine/combineinnerwallcluster1024_003a.mdl",Vector(0.05,0.08,0.02),false,Color(255,40,40),"")),
            Holo(SubHolo(Vector(20,0,5),Angle(0,0,0),"models/weapons/w_physics.mdl",Vector(1.20,1.20,1.20),false,Color(255,40,40),"")),
            ...
            Holo(SubHolo(Vector(-30,-6,0),Angle(-10,-180,180),"models/props_lab/servers.mdl",Vector(0.49,0.49,0.49),false,Color(255,40,40),""))
        ),
        hologram.createPart(
            Holo(SubHolo(Vector(0,0,-11),Angle(0,0,0),"models/props_phx/wheels/moped_tire.mdl",Vector(1.8,1.8,2.2),false,Color(255,40,40),"models/props_combine/metal_combinebridge001"))
        ),
    ...
    head = hologram.createPart(
        ...
        Holo(SubHolo(Vector(12,0,25),Angle(0,0,0),"models/hunter/misc/sphere075x075.mdl",Vector(0.18,0.08,0.4),false,Color(255,255,255,255),"models/ihvtest/eyeball_l")),
        ...
        Holo(SubHolo(Vector(3,0,40),Angle(0,0,-5),"models/weapons/w_physics.mdl",Vector(1,1,1.1),false,Color(255,0,0,255),""))
