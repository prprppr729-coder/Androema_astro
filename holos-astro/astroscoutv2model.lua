...
body = {
    ...
    rightarm = {
        ...
        hologram.createPart(
            ...
            Holo(SubHolo(Vector(-9.1,-344,53),Angle(-90,90,0),"models/props_combine/combineinnerwall001a.mdl",Vector(0.04,0.289,0.188),true,Color(255,40,40,255),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(-9.1,-344,53),Angle(-90,90,0),"models/props_combine/combineinnerwall001a.mdl",Vector(0.05,0.290,0.189),true,Color(255,255,255,255),"models/wireframe"))
        )
    },
    leftarm = {
        hologram.createPart(
