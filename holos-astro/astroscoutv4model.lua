...
body = {
    base = {
        hologram.createPart(
            ...
            Holo(SubHolo(Vector(-60,0,40),Angle(0),"models/props_combine/combineinnerwall001a.mdl",Vector(0.04,0.74,0.34),false,Color(255,40,40))),
            Holo(SubHolo(Vector(-60,60,40),Angle(10,0,-30),"models/props_combine/combineinnerwall001a.mdl",Vector(0.04,0.04,0.09),true,Color(255,40,40),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(-60,-60,40),Angle(-10,0,30),"models/props_combine/combineinnerwall001a.mdl",Vector(0.04,0.04,0.09),true,Color(255,40,40),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(-60,-60,40),Angle(-10,0,30),"models/props_combine/combineinnerwall001a.mdl",Vector(0.04,0.04,0.09),true,Color(255,255,255),"models/wireframe")),
            Holo(SubHolo(Vector(-60,60,40),Angle(10,0,-30),"models/props_combine/combineinnerwall001a.mdl",Vector(0.04,0.04,0.09),true,Color(255,255,255),"models/wireframe")),
            Holo(SubHolo(Vector(-60,0,40),Angle(-730,180,180),"models/props_combine/combine_bridge.mdl",Vector(0.21,0.56,0.34),false,Color(255,40,40))),
            ...
            Holo(SubHolo(Vector(30,-72,0),Angle(0,-90,0),"models/props_combine/combineinnerwall001a.mdl",Vector(0.03,0.3,0.03),false,Color(255,40,40),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(30,72,0),Angle(0,90,0),"models/props_combine/combineinnerwall001a.mdl",Vector(0.03,0.3,0.03),false,Color(255,40,40),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(30,-72,0),Angle(0,-90,0),"models/props_combine/combineinnerwall001a.mdl",Vector(0.03,0.3,0.03),false,Color(2255,255,255),"models/wireframe")),
            Holo(SubHolo(Vector(30,72,0),Angle(0,90,0),"models/props_combine/combineinnerwall001a.mdl",Vector(0.03,0.3,0.03),false,Color(255,255,255),"models/wireframe")),
            Holo(SubHolo(Vector(-10,0,-19),Angle(50,180,180),"models/props_combine/combineinnerwallcluster1024_003a.mdl",Vector(0.10,0.10,0.10),false,Color(255,40,40))),
            Holo(SubHolo(Vector(10,0,-19),Angle(130,-180,0),"models/props_combine/combineinnerwallcluster1024_003a.mdl",Vector(0.10,0.10,0.10),false,Color(255,40,40))),
            Holo(SubHolo(Vector(0,0,-19),Angle(180,0,0),"models/props_combine/portalspire.mdl",Vector(0.70,0.70,0.05),false,Color(255,40,40))),
        ...
        hologram.createPart(
            ...
            Holo(SubHolo(Vector(0,0,5),Angle(0,0,0),"models/hunter/misc/sphere075x075.mdl",Vector(4.40,4.40,1),true,Color(255,40,40),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(0,0,0),Angle(0,0,0),"models/hunter/tubes/circle2x2.mdl",Vector(1.20,1.20,1.20),false,Color(255,40,40),"models/props_combine/metal_combinebridge001")),
            Holo(SubHolo(Vector(0,0,0),Angle(0,0,0),"models/hunter/tubes/tube4x4x025.mdl",Vector(0.82,0.82,0.82),false,Color(255,40,40),"models/wireframe")),
            Holo(SubHolo(Vector(0,0,20),Angle(0,0,0),"models/props_phx/gears/spur36.mdl",Vector(2.75,2.75,0.200),false,Color(255,40,40),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(0,0,15),Angle(0,0,0),"models/props_phx/gears/spur36.mdl",Vector(2.75,2.75,0.200),false,Color(255,255,255),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(0,0,20),Angle(0,0,0),"models/props_phx/gears/spur36.mdl",Vector(2.76,2.76,0.201),false,Color(255,40,40),"models/wireframe")),
            Holo(SubHolo(Vector(0,0,15),Angle(0,0,0),"models/props_phx/gears/spur36.mdl",Vector(2.76,2.76,0.201),false,Color(255,255,255),"models/wireframe")),
            Holo(SubHolo(Vector(0,0,-05),Angle(0,0,0),"models/props_phx/gears/spur36.mdl",Vector(2.75,2.75,0.200),false,Color(255,40,40),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(0,0,-10),Angle(0,0,0),"models/props_phx/gears/spur36.mdl",Vector(2.75,2.75,0.200),false,Color(255,255,255),"models/debug/debugwhite")),
            Holo(SubHolo(Vector(0,0,-05),Angle(0,0,0),"models/props_phx/gears/spur36.mdl",Vector(2.76,2.76,0.201),false,Color(255,40,40),"models/wireframe")),
            Holo(SubHolo(Vector(0,0,-10),Angle(0,0,0),"models/props_phx/gears/spur36.mdl",Vector(2.76,2.76,0.201),false,Color(255,255,255),"models/wireframe")),
            Holo(SubHolo(Vector(0,0,10),Angle(0,50,180),"models/hunter/tubes/tube4x4x025.mdl",Vector(0.82,0.82,0.82),false,Color(255,40,40),"models/wireframe")),
    ...
    rightarm = {
        ...
        hologram.createPart(
            ...
            Holo(SubHolo(Vector(-3,-190,24),Angle(270,90,0),"models/props_combine/combine_bridge.mdl",Vector(-0.10,0.90,0.50),false,Color(255,40,40))),
        ...
        hologram.createPart(
            ...
            Holo(SubHolo(Vector(-9.1,-344,49),Angle(-90,90,0),"models/props_combine/combineinnerwall001a.mdl",Vector(0.04,0.289,0.188),true,Color(255,255,255,255),"models/wireframe"))
        )
    },
    leftarm = {
        hologram.createPart(
